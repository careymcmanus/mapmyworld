...
if("TRUE" STREQUAL "TRUE")
  set(where_am_i_SOURCE_PREFIX /home/workspace/catkin_ws/src/where_am_i/where_am_i)
...
if(NOT "/home/workspace/catkin_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'carey <careymcmanus@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'where_am_i' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/catkin_ws/src/where_am_i/where_am_i/${idir}'.  ${_report}")
    endif()
...
set(where_am_i_EXPORTED_TARGETS "where_am_i_generate_messages_cpp;where_am_i_generate_messages_eus;where_am_i_generate_messages_lisp;where_am_i_generate_messages_nodejs;where_am_i_generate_messages_py")
...
set(pkg_cfg_extras "where_am_i-msg-extras.cmake")
